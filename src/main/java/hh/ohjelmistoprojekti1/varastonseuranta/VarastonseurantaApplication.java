...
public class VarastonseurantaApplication {
	...
	public CommandLineRunner demo(ProductRepository productRepo, ManufacturerRepository manufacturerRepository,
		...
		return (args) -> {
			...
			// food -data
			Food food1 = new Food("Kananappulat", 29.95, manufacturer4, "kuivaruoka", DogAge.Aikuinen);
			foodRepository.save(food1);
			Food food2 = new Food("Koiranmakkara, nauta", 5.95, manufacturer5, "märkäruoka", DogAge.Aikuinen);
			foodRepository.save(food2);
			Food food3 = new Food("Lammasnappulat", 20.99, manufacturer6, "kuivaruoka", DogAge.Vanhus);
			foodRepository.save(food3);
			Food food4 = new Food("Lammasta ja riisiä, pentunappulat", 35.95, manufacturer4, "kuivaruoka", DogAge.Pentu);
