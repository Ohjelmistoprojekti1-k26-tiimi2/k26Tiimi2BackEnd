...
public class VarastonseurantaApplication {
	...
	public CommandLineRunner demo(UserRepository userRepository, ProductRepository productRepo,
		...
		return (args) -> {
			 ...
			 * 
			 * // clothing -data
			 * Clothing clothing1 = new Clothing("Pikku mussukan sadetakki", 19.99,
			 * manufacturer2, Size.M, "Pinkki");
			 * clothingRepository.save(clothing1);
			 * Clothing clothing2 = new Clothing("Pikku mussukan tohvelit", 24.95,
			 * manufacturer2, Size.S, "Musta");
			 * clothingRepository.save(clothing2);
			 * Clothing clothing3 = new Clothing("Tassuttelijan pusero", 22.95,
			 * manufacturer1, Size.L, "Harmaa");
			 * clothingRepository.save(clothing3);
			 * Clothing clothing4 = new Clothing("Karvaturren talvitakki", 37.99,
			 * manufacturer3, Size.L, "Oliivin vihreä");
			 * clothingRepository.save(clothing4);
			 * 
			 * // toy -data
			 * Toy toy1 = new Toy("Aktivointipallo", 14.95, manufacturer7,
			 * "Aktivointilelut", Size.L);
			 * toyRepository.save(toy1);
			 * Toy toy2 = new Toy("Puruluu Bone", 13.99, manufacturer9, "Purulelut",
			 * Size.M);
